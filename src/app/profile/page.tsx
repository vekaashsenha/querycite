...
export default async function ProfilePage() {
  ...
  return (
    <DashboardShell
      ...
      badge={<StatusPill tone="green">Verified full access</StatusPill>}
    >
      <AppCard className="p-6">
        <WorkspaceHeader
        ...
        <div className="mt-5 rounded-2xl border border-emerald-100 bg-emerald-50 p-4 text-sm font-semibold leading-6 text-emerald-900">
          Signed in as {user.email}. Competitor changes left this billing period: {access.limits.competitorChanges} / {access.limits.competitorChanges}.
        </div>
      </AppCard>
